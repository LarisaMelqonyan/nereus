  ...
  return (
    <div className={classes.root}>
      <Grid container spacing={24}>
        ...
        <Grid item xs={6}>
          <Paper className={classes.paper}>
            <h3>Bright Glory Voyage Details</h3>
            <Table className={classes.table}>
              <TableHead>
                <TableRow>
                  <TableCell> </TableCell>
...
export default withStyles(styles)(LivornoVoyage);
